...
<body>
    ...
    <div class="agileits_header">
      <div class="w3l_offers"> <a href="#">Kisan Agri Mall</a> </div>
    ...
    <div class="logo_products">
      <div class="container">
        <div class="w3ls_logo_products_left">
          <h1><a href="index.php"><span>Kisan Agri</span> Mall</a></h1>
        </div>
        ...
        <div class="w3ls_logo_products_left1">
          <ul class="phone_email">
            <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+919979331605">(+91)9021476605</a></li>
            <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:store@grocery.com"> <a href="mailto:kisanagrimall@gmail.com">kisanagrimall@gmail.com</a></li>
          </ul>
        </div>
        <div class="clearfix"></div>
      </div>
